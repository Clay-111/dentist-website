...
<header class="header fixed-top">
   ...
   <div class="container">
      ...
      <div class="row align-items-center justify-content-between">
         ...
         <a href="Contact.php" target="blank" class="link-btn">make appointment</a>
...
<section class="footer" id="footer">
   ...
   <div class="box-container container">
      ...
      <div class="box">
         ...
         <h3>Email address</h3>
         <p>himel@gmail.com</p>
         <p>jannat@gmail.com</p>
      </div>

   </div>

   <div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> by <span>Himel & Jannat</span>  </div>
